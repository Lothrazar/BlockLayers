...
sed -i -e "s/${original}/${texture}/g" "${folder}"/models/block/"${newblock}"_height2.json
sed -i -e "s/${original}/${texture}/g" "${folder}"/models/block/"${newblock}"_height4.json
sed -i -e "s/${original}/${texture}/g" "${folder}"/models/block/"${newblock}"_height6.json
sed -i -e "s/${original}/${texture}/g" "${folder}"/models/block/"${newblock}"_height8.json
sed -i -e "s/${original}/${texture}/g" "${folder}"/models/block/"${newblock}"_height10.json
sed -i -e "s/${original}/${texture}/g" "${folder}"/models/block/"${newblock}"_height12.json
sed -i -e "s/${original}/${texture}/g" "${folder}"/models/block/"${newblock}"_height14.json
...
echo "  \"block.blocklayering.${newblock}\":\"${newblock} Layer\", "
